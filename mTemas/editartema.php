        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3">
                    ...
                    <input type="hidden" name="colorLe" id="colorLe" class="minicolors-input colors" value="#ffffff" size="7">  
                    <br>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3">
                    <label for="colorBe">Color de Base: </label>
                    <input type="hidden" name="colorBe" id="colorBe" class="minicolors-input colors" value="#ffffff" size="7">  
                    <br>            
                </div>
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3">
                    <label for="colorBFe">Color de Base Fuerte: </label>
                    <input type="hidden" name="colorBFe" id="colorBFe" class="minicolors-input colors" value="#ffffff" size="7">  
                    <br>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3">
                    <label for="colorBde">Color de Borde: </label>
                    <input type="hidden" name="colorBde" id="colorBde" class="minicolors-input colors" value="#ffffff" size="7">  
                    <br>
                </div>
            </div>
        </div>
